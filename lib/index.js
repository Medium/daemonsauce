...
function setLogDir(dir) {
    ...
    // Do "fallback" logging setup, which is to log stdout and stderr
    // to a file. Some time after this, the higher layer of logging
    // could (and perhaps should) end up getting redirected, but some
    // things (such as, notably, Node's internal "death throes" error
    // reporting) only ever use the underlying stdio descriptors.

    daemonsauceNative.reopenStderr(logFile);
    daemonsauceNative.reopenStdout(logFile);
}
